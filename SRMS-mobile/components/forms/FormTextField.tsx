...
import { KeyboardTypeOptions, StyleProp, TextInputProps, TextStyle, View } from "react-native";
...
export function FormTextField({ label, style, togglePasswordBtn, keyboardType, autoComplete }: FormTextFieldProps) {
